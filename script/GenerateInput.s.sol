...
contract GenerateInput is Script {
    uint256 private constant AMOUNT = 25 * 1e18; //Amount we want the address to claim airdrop
    string[] types = new string[](2); //Type of the value in the Merkle tree, Address and Amount
    uint256 count; // Number of address able to claim airdrop
    string[] whitelist = new string[](4); //The address here and the ones that are allowed to claim airdrop
    string private constant INPUT_PATH = "/script/target/input.json"; //File path to print generated Merkle Tree too
